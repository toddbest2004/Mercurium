...
router.post("/register", function(req,res){
	...
	db.usermodel.findOne({username:req.body.username}, function(err, user){
		...
		newuser = new db.usermodel({username:req.body.username, password:req.body.password1})
		newuser.save()
...
router.get("/games/", function(req,res){
	...
	db.usermodel.findOne({username:req.session.username}).populate('games').exec(function(err, user){
